export const en = {
  ...
  process: {
    title: 'First Visit Flow',
    sub: 'Know what to expect before you arrive',
    nhiLabel: 'NHI Consultation',
    ...
    steps: [
      {
        num: '01',
        title: 'Check In',
        desc: "Bring any prior imaging (X-ray, MRI) if available. No worries if you don't have any.",
      },
      {
        num: '02',
        title: 'Detailed Consultation',
        desc: "The doctor takes time to understand: how long, what you've tried, what matters most to you.",
      },
      {
        num: '03',
  ...
  blog: {
    ...
    featured: [
      ...
      {
        title: 'What is TAME? Controlling Pain Through Micro-Arterial Embolization',
        tag: 'TAME',
